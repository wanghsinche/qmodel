...
export default function QDIIDetail() {
    ...
    if (isValidating) {
        return  <Skeleton placeholder={
            ...
            <Skeleton.Image style={{ width: 500, height: 300, margin: '10px auto' }} />
            <Skeleton.Paragraph rows={2} />
            <Skeleton.Image style={{ width: 500, height: 300, margin: '10px auto' }} />
            </>
        } style={{ width: '50vw' }} loading={true}></Skeleton>
    ...
    return <div>
        ...
        <LineChart width={500} height={300} data={lineDataset}>
        ...
        <BarChart width={500} height={300} data={histogramDataset}>
            <CartesianGrid strokeDasharray="3 3" />
